...
export const managers = [
    {
      ...
      "philosophy": "Pound them on the ground! Always wanting to have that good ground attack surrounded by good recievers and a great QB",
      "tradingScale": 5, // 1 - 10
    ...
    },
   {
      ...
      },
    {
      ...
      "photo": "/managers/Tommy Reed.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2014, // (optional) when did the manager start playing fantasy football
      ...
      },
    {
      ...
      "photo": "/managers/JT.jpg", // square ratio recommended (no larger than 500x500)
      ...
      },
    {
      ...
      "photo": "/managers/Levi.JPG", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2018, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "ind", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Dynasty", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
